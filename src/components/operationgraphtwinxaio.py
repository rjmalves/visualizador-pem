...
class OperationGraphTwinxAIO(html.Div):
    ...
    def __init__(
        ...
        super().__init__(
            [
                                ...
                                html.Div(
                                    children=[
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.usina_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.usina_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.ree_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.ree_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.submercado_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.submercado_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.submercadoDe_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.submercadoDe_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.submercadoPara_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.submercadoPara_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.patamar_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                            ...
                                            style={"display": "none"},
                                            id=self.ids.patamar_dropdown_container_twinx(
                                                aio_id
                                            ),
                                            className="dropdown-container",
                                        ),
                                        html.Div(
                                            children=[
                                                dcc.Dropdown(
                                                    id=self.ids.variable_dropdown_twinx(
                                                        aio_id
                                                    ),
                                                    options=[],
                                                    value=None,
                                        ...
                                        html.Button(
                                            "CSV",
                                            id=self.ids.download_btn_twinx(
                                                aio_id
                                            ),
                                        ),
                                    ],
                ...
                dcc.Store(
                    id=self.ids.data_twinx(aio_id),
                    storage_type=Settings.storage,
                ),
                dcc.Store(
                    id=self.ids.options_twinx(aio_id),
                    storage_type=Settings.storage,
                ),
                dcc.Store(
                    id=self.ids.filters_twinx(aio_id),
                    storage_type=Settings.storage,
                ),
                dcc.Download(id=self.ids.download(aio_id)),
                dcc.Download(id=self.ids.download_twinx(aio_id)),
            ],
            className="card",
        )
    ...
    @callback(
        Output(ids.usina_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_usina_dropdown_twinx(variavel: str):
        agregacao_espacial = variavel.split("_")[1] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_espacial in ["UHE", "UTE", "UEE"]
    ...
    @callback(
        Output(ids.ree_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_ree_dropdown_twinx(variavel: str):
        agregacao_espacial = variavel.split("_")[1] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_espacial == "REE"
    ...
    @callback(
        Output(ids.submercado_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_submercado_dropdown_twinx(variavel: str):
        agregacao_espacial = variavel.split("_")[1] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_espacial == "SBM"
    ...
    @callback(
        Output(ids.submercadoDe_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_submercadoDe_dropdown_twinx(variavel: str):
        agregacao_espacial = variavel.split("_")[1] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_espacial == "SBP"
    ...
    @callback(
        Output(ids.submercadoPara_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_submercadoPara_dropdown_twinx(variavel: str):
        agregacao_espacial = variavel.split("_")[1] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_espacial == "SBP"
    ...
    @callback(
        Output(ids.patamar_dropdown_container_twinx(MATCH), "style"),
        Input(ids.variable_dropdown_twinx(MATCH), "value"),
    )
    def update_display_patamar_dropdown_twinx(variavel: str):
        agregacao_temporal = variavel.split("_")[2] if variavel else ""
        return (
            {"display": "flex"}
            if agregacao_temporal == "PAT"
    ...
    @callback(
        Output(ids.usina_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_usina_options_twinx(interval, options):
        if options:
            if "usina" in options.keys():
                return sorted(list(set(options["usina"])))
        return []
    ...
    @callback(
        Output(ids.ree_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_ree_options_twinx(interval, options):
        if options:
            if "ree" in options.keys():
                return sorted(list(set(options["ree"])))
        return []
    ...
    @callback(
        Output(ids.submercado_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_submercado_options_twinx(interval, options):
        if options:
            if "submercado" in options.keys():
                subs = list(set(options["submercado"]))
                return sorted(
    ...
    @callback(
        Output(ids.submercadoDe_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_submercadoDe_options_twinx(interval, options):
        if options:
            if "submercadoDe" in options.keys():
                subs = list(set(options["submercadoDe"]))
                return sorted(
    ...
    @callback(
        Output(ids.submercadoPara_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_submercadoPara_options_twinx(interval, options):
        if options:
            if "submercadoPara" in options.keys():
                subs = list(set(options["submercadoPara"]))
                return sorted(
    ...
    @callback(
        Output(ids.patamar_dropdown_twinx(MATCH), "options"),
        Input(ids.updater(MATCH), "n_intervals"),
        Input(ids.options_twinx(MATCH), "data"),
    )
    def update_patamar_options_twinx(interval, options):
        if options:
            if "patamar" in options.keys():
                return sorted(list(set(options["patamar"])))
        return []
    ...
    @callback(
        Output(ids.filters_twinx(MATCH), "data"),
        Input(ids.usina_dropdown_twinx(MATCH), "value"),
        Input(ids.ree_dropdown_twinx(MATCH), "value"),
        Input(ids.submercado_dropdown_twinx(MATCH), "value"),
        Input(ids.submercadoDe_dropdown_twinx(MATCH), "value"),
        Input(ids.submercadoPara_dropdown_twinx(MATCH), "value"),
        Input(ids.patamar_dropdown_twinx(MATCH), "value"),
    )
    def update_filters_twinx(
        usina: str,
        ree: str,
        submercado: str,
        submercado_de: str,
    ...
    @callback(
        Output(ids.download_twinx(MATCH), "data"),
        Input(ids.download_btn_twinx(MATCH), "n_clicks"),
        State(ids.data_twinx(MATCH), "data"),
    )
    def generate_csv(n_clicks, operation_data):
        if n_clicks is None:
            return
